...
CREATE TABLE `appointments` (
  ...
  `status` enum('RESERVED','CONFIRMED','CANCELED','SERVED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RESERVED',
...
(11, '2018_03_22_143009_create_services_table', 1),
(12, '2018_03_22_143311_create_blogs_table', 1),
(13, '2018_03_22_153311_create_testimonials_table', 1),
(14, '2018_03_22_163311_create_galleries_table', 1),
...
CREATE TABLE `settings` (
  `id` int(10) UNSIGNED NOT NULL,
  `app_title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `appointments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `foreign_appointment_user` (`user_id`),
  ADD KEY `foreign_appointment_services` (`service_id`);
...
--
ALTER TABLE `appointments`
  ADD CONSTRAINT `foreign_appointment_services` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `foreign_appointment_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
