...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route'=>['admin.testimonials.store'],'method' => 'post','class'=>'form-horizontal form-label-left', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="testimonial" class="form-control col-md-7 col-xs-12 @if($errors->has('testimonial')) parsley-error @endif"
                                  name="testimonial" required></textarea>
